...
# syntax error -the the formatting rules of a language. in this case, a progamming language.
# type error -TypeError is raised whenever an operation is performed on an incorrect/unsupported object type.
# name error - common excel error notation

# 3. What function would I use if I wanted to convert an integer data type into 
# a string data type? (str) function

# 4. What function would I use if I wanted to change a float data type into a 
# an integer data type? (int) function
