...
# 1. In your own words, what is a computer program? program language follows and execute

# 2. Name three (3) data types string ?,interger,float

# 3. Name three (3) python Operators? Logical,Arithmatic,Assignment
